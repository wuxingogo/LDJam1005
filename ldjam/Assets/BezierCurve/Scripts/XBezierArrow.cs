...
public class XBezierArrow : XMonoBehaviour
{
	...
	[X]
	public List<Vector3> GetTotalPoints()
	{
...
//		Triangles.AddRange( new List<int>{currIndex , currIndex + 1, currIndex + 2});
//		Triangles.AddRange( new List<int>{currIndex +2, currIndex + 1, currIndex + 3});
